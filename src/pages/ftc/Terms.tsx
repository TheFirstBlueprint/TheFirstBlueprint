...
const FtcTerms = () => {
  return (
    <>
      <Helmet>
        <title>TheFirstBlueprint | FTC Terms</title>
        <meta
          name="description"
          content="FTC planning terms of service."
        />
      </Helmet>
          ...
          <section className="panel">
            ...
            <div className="space-y-4 text-sm text-muted-foreground">
              <p><span className="text-foreground">Purpose of the Website</span><br />
                TheFirstBlueprint FTC planning tools are provided for strategy visualization and team communication.
