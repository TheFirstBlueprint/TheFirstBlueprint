...
const FtcLicense = () => {
  return (
    <>
      <Helmet>
        <title>TheFirstBlueprint | FTC License</title>
        <meta
          name="description"
          content="FTC planning licensing and third-party asset credits."
        />
      </Helmet>
        ...
        <main className="mx-auto w-full max-w-4xl px-6 py-10 flex-1">
          <section className="panel">
            ...
            <div className="space-y-4 text-sm text-muted-foreground">
              <p>
                This tool includes field map images from the Pedro-Pathing Visualizer project, licensed under the
                Apache License, Version 2.0. Field images have been modified from the original assets.
              </p>
